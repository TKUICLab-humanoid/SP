...
def find_target():
    ...
    if sp.Right_Object[0]>sp.Left_Object[0] and sp.Right_Object[1]>sp.Left_Object[1] and 0.5<(sp.Left_Object[3]-sp.Left_Object[2])/(sp.Right_Object[1]-sp.Left_Object[0])<1.5:
